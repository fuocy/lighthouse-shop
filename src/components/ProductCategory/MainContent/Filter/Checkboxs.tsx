...
//               ${selectedBrands[position] && "text-black"}
//               ${selectedBrands[position] && "font-medium"}
//               ${selectedBrands[position] && "after:absolute"}
//               ${selectedBrands[position] && "after:top-[8.19px] "}
//               ${selectedBrands[position] && "after:bg-black"}
//               ${selectedBrands[position] && "after:left-[-32px]"}
//               ${selectedBrands[position] && "after:w-[10px]"}
//               ${selectedBrands[position] && "after:h-[2px]"}
//               ${selectedBrands[position] && "after:rotate-[128deg]"}
//               ${selectedBrands[position] && "before:absolute"}
//               ${selectedBrands[position] && "before:top-[8.19px]"}
//               ${selectedBrands[position] && "before:bg-black"}
//               ${selectedBrands[position] && "before:left-[-34px]"}
//               ${selectedBrands[position] && "before:w-[5px]"}
//               ${selectedBrands[position] && "before:h-[2px]"}
//               ${selectedBrands[position] && "before:rotate-[-133deg]"}
//               `}
//             >
